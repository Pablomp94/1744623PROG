        ...
        if (opc == 1) {
            ...
            if (opc == 1) {
                ...
                if (gastar <= saldo1) {
                    ...
                    System.out.println("Has gastado " + gastar + " euros, te quedan " + saldo1
                            + " euros en la tarjeta numero uno.");
                } else {
            ...
            if (opc == 2) {
                ...
                if (gastar <= saldo2) {
                    ...
                    System.out.println("Has gastado " + gastar + " euros, te quedan " + saldo2
                            + " euros en la tarjeta numero dos.");
                } else {
                    System.out.println("No puedes introducir unos gastos mayores al dinero en la tarjeta");
                }
                System.out.println(" ");
